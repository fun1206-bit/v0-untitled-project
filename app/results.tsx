    ...
    <div className="flex min-h-screen flex-col items-center bg-amber-50 px-4 py-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md grid grid-cols-2 gap-4 mb-8 relative z-10">
        {recommendedDishes.map((dish) => (
          ...
          >
            <div className="mb-2">
              <FoodTypeIcon type={dish.type} className="h-16 w-16" />
            </div>
            <h3
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          ...
          >
            ...
            <div className="flex items-center mb-4">
              <FoodTypeIcon type={selectedRecipe.type} className="h-12 w-12 mr-3" />
              <h2
    ...
    case "meat":
      return (
        <svg viewBox="0 0 100 100" className={className}>
          ...
          <path
            d="M30,35 C35,30 65,30 70,35 C75,40 75,60 70,65 C65,70 35,70 30,65 C25,60 25,40 30,35 Z"
            fill="#FF8A65"
            stroke="#E64A19"
            strokeWidth="3"
            strokeLinecap="round"
          ...
          />
          <path d="M40,40 C45,45 55,45 60,40" fill="none" stroke="#E64A19" strokeWidth="2" strokeLinecap="round" />
          <path d="M40,50 C45,55 55,55 60,50" fill="none" stroke="#E64A19" strokeWidth="2" strokeLinecap="round" />
          <path d="M40,60 C45,65 55,65 60,60" fill="none" stroke="#E64A19" strokeWidth="2" strokeLinecap="round" />
        </svg>
      )
    case "vegetable":
      return (
        <svg viewBox="0 0 100 100" className={className}>
          ...
          />
          <path
            d="M50,60 C45,70 40,75 50,80 C60,75 55,70 50,60 Z"
            fill="#81C784"
            stroke="#388E3C"
            strokeWidth="3"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
          <path d="M40,35 C45,40 55,40 60,35" fill="none" stroke="#388E3C" strokeWidth="2" strokeLinecap="round" />
          <path d="M40,45 C45,50 55,50 60,45" fill="none" stroke="#388E3C" strokeWidth="2" strokeLinecap="round" />
        </svg>
      )
    case "soup":
      return (
        <svg viewBox="0 0 100 100" className={className}>
          ...
          <path
            d="M25,40 C25,35 35,30 50,30 C65,30 75,35 75,40 L75,60 C75,65 65,70 50,70 C35,70 25,65 25,60 Z"
            fill="#90CAF9"
            stroke="#1565C0"
            strokeWidth="3"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
          <ellipse cx="50" cy="40" rx="25" ry="5" fill="#64B5F6" />
          <path
            d="M35,50 C40,55 45,50 50,55 C55,50 60,55 65,50"
            fill="none"
            stroke="#1565C0"
            strokeWidth="2"
            strokeLinecap="round"
